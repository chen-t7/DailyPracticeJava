...
public class TestDemo {
    ...
    public static void main5(String[] args) {
        ...
        priorityQueue2.offer(card1);
        priorityQueue2.offer(card2);
    ...
    public static void main2(String[] args) {
        ...
        TestSmallHeap testSmallHeap = new TestSmallHeap();
        testSmallHeap.createSmallHead(array2);
        testSmallHeap.offer(80);
        //testSmallHeap.heapSort();
        System.out.println("============");
        System.out.println(testSmallHeap.poll());
        System.out.println(testSmallHeap.poll());
    }
}
